...
def keyword_extractor_agent(state: AppState) -> AppState:
    ...
    stopwords = {
        ...
        '작년', '올해', '내년', '재작년', '후년', '언제', '아까', '방금', '조금', '잠깐',
        '당장', '이미', '벌써', '아직', '여전히', '계속', '항상', '자꾸', '막',
        
        # 대명사/지시어
        '나', '너', '저', '우리', '저희', '당신', '그', '이', '그것', '이것', '저것',
        '여기', '거기', '저기', '어디', '누구', '무엇', '뭐', '어느', '어떤',
        '나도', '너도', '저도', '우리도', '이거', '그거', '저거', '요거',
        '자기', '자신', '본인', '서로',
        
        # 수량/정도/순서
        '하나', '둘', '셋', '한', '두', '세', '네', '다섯', '여섯', '일곱', '여덟', '아홉', '열',
        '첫', '두번째', '세번째', '처음', '마지막', '번째', '번', '개', '명', '분', '시간',
        '거번', '한번', '두번', '몇', '여러', '모든', '각', '전체', '일부',
        '많이', '적게', '조금', '약간', '거의', '완전', '아주', '매우', '너무', '정말',
        '진짜', '엄청', '되게', '좀', '더', '덜', '제일', '가장',
